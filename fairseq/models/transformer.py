...
class TransformerModel(FairseqEncoderDecoderModel):
    ...
    def add_args(parser):
        ...
        ################### Adding arguments look neighbor ######
        parser.add_argument('--concatLast', default=False, action='store_true',)
        parser.add_argument('--insertNeighborAttn', default=False, action='store_true',
...
class TransformerDecoder(FairseqIncrementalDecoder):
    ...
    def __init__(self, args, dictionary, embed_tokens, no_encoder_attn=False):
        ...
        # import pdb
        # pdb.set_trace()
        # args.insertCausalSelfAttn = False
        self.layers.extend(
            [
        ...
        # args.insertCausalSelfAttn = True
