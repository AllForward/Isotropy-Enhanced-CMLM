...
@register_model_architecture(
    "cmlm_transformer", "cmlm_transformer_iwslt"
)
...
@register_model_architecture(
    "cmlm_transformer", "cmlm_transformer_12_6"
)
def cmlm_12_6_architecture(args):
...
@register_model_architecture(
    "cmlm_transformer", "cmlm_transformer_roberta_12_6"
)
def cmlm_roberta_12_6_architecture(args):
    args.encoder_layers = getattr(args, "encoder_layers", 12)
